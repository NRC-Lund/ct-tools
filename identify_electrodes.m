...
%             [app.points.Selected] = deal(false);
        ...
        function LoadMarkersMatMenuSelected(app, event)
            ...
            if isfield(L, 'markers')
                ...
                % Update GUI:
                try
                    labels = cellstr(num2str(L.markers.dbid));
                catch
                    labels = cellstr(L.markers.dbid);
                end
        ...
        function SaveMarkersMenuSelected(app, event)
            ...
            if isequal(file,0)
                ...
                try
                    labels = cellfun(@str2num,app.WireLabels);
                catch
                    labels = string(app.WireLabels);
                end
                markers = table(labels, ...
                    app.TargetMarkers(:,1), ...
                    app.TargetMarkers(:,2), ...
                    app.TargetMarkers(:,3), ...
                    app.StartMarkers(:,1), ...
